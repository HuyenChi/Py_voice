...
DAYS = ['monday','tuesday','wednesday','thursday','friday','seturday','sunday']
...
def get_event(n,service):
    # n là số event được gọi
    # service là thông tin build đươọc tạo ở trên phần authenticate_google
